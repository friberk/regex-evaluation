...
class PCREListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by PCREParser#accept_.
    def enterAccept_(self, ctx:PCREParser.Accept_Context):
        pass

    # Exit a parse tree produced by PCREParser#accept_.
    def exitAccept_(self, ctx:PCREParser.Accept_Context):
        pass
