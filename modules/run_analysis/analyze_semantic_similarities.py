...
from regex_semantic_sim import symmetrical_semantic_similarity

BEST_TARGETS = {
    "reuse-by-example": ["../../data/generated-regexes-with-syntactic-similarities/reuse-by-example/full-match/full_match.ndjson", "../../data/generated-regexes-with-syntactic-similarities/reuse-by-example/partial-match/partial_match.ndjson"],
    "rfixer": ["../../data/generated-regexes-with-syntactic-similarities/synthesizers/rfixer/full-match/full_match.ndjson", "../../data/regex-reuse/generated-regexes-with-syntactic-similarities/synthesizers/rfixer/partial-match/partial_match.ndjson"],
    "o3-mini": ["../../data/generated-regexes-with-syntactic-similarities/llms/o3-mini/full-match/full_match.ndjson", "../../data/regex-reuse/generated-regexes-with-syntactic-similarities/llms/o3-mini/partial-match/partial_match.ndjson"]
}

# Configuration
BASE_DIR = "../../data"
INPUT_DIR = f"{BASE_DIR}/generated-regexes-with-syntactic-similarities"
OUTPUT_DIR = f"{BASE_DIR}/generated-regexes-with-semantic-similarities"
...
def exec_semantic_sim_with_timeout(ground_truth_regex, candidate_regex, timeout_seconds=10):
    """Execute a regex with a timeout."""
    try:
        with timeout(timeout_seconds):
            return symmetrical_semantic_similarity(ground_truth_regex, candidate_regex)
    except TimeoutError:
    ...
    for line in f:
        try:
            ...
            for candidate in candidates:
                ...
                if not regex:
                    symmetrical_semantic_similarity = None
                else:
                    try:
                        similarity = exec_semantic_sim_with_timeout(ground_truth_regex, regex)
                        symmetrical_semantic_similarity = round(similarity["symmetric_accuracy"], 4)
                    except Exception as e:
                        print(f"Error while calculating semantic similarity: {e}")
                        symmetrical_semantic_similarity = None

                candidate["symmetrical_semantic_similarity"] = symmetrical_semantic_similarity
